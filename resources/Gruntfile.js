		...
		makepot     : {
			pot: {
				options: {
					cwd        : '..',
					exclude    : [ 'resources' ],
					mainFile   : 'text-modules.php',
					potComments: 'Copyright (C) {{year}} Text Modules\nThis file is distributed under the same license as the Text Modules package.',
					potFilename: '<%= globalConfig.textdomain %>.pot',
					potHeaders : {
						poedit                 : true,
						'report-msgid-bugs-to' : 'https://github.com/tfrommen/text-modules/issues',
